...
if IS_WINDOWS:
    ...
    winget_node_path = os.path.join(
        user_profile, 
        "AppData", "Local", "Microsoft", "WinGet", "Packages",
        "OpenJS.NodeJS.LTS_Microsoft.Winget.Source_8wekyb3d8bbwe",
        "node-v24.17.0-win-x64"
    )
    if os.path.exists(winget_node_path):
        os.environ["PATH"] = winget_node_path + os.pathsep + os.environ["PATH"]
...
def main():
    ...
    if esp32_port:
        ...
        try:
            ...
            print("[*] Non-interactive environment detected. Defaulting to SIMULATED DEMO MODE.")
            demo_mode = True
