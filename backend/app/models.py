...
class Alert(Base):
    ...
    status = Column(String, default="active") # active, acknowledged, dispatched, resolved, false_alarm
    action_taken = Column(String, default="none") # none, acknowledged, dispatched, resolved, false_alarm
